<!-- Aqui esta donde se llama a todos los views anterior mente mencionados-->
<template>
  <div id="app">
    <Chatbot />
...
.qkb-bubble-btn {
  width: 50px !important; /* Sobrescribe el ancho */
  height: 50px !important; /* Sobrescribe la altura */
