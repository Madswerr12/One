...
export default {
  ...
  data() {
    return {
      welcomeScreen: {
        title: "Bienvenido a Base de conocimiento Iding",
        blogPost:
          "Ingresa sesion para ver la base de conocimiento segun tu area",
        welcomeScreen: true,
        photo: "1",
      },
...
.updates {
  ...
  border: 2px solid #030303; // Cambia esto al color del contorno que desees
