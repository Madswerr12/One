<!-- Aqui esta pagina para editar post-->
<template>
  <div class="create-post">
    ...
    <div class="container">
      ...
      <div class="blog-actions">
        ...
        <router-link class="router-button" :to="{ name: 'BlogPreview' }">Visualizar Cambios</router-link>
      </div>
    </div>
  </div>
</template>
...
export default {
  ...
  async mounted() {
    ...
    // Establecer el estado del blog actual y asignar los tags
    this.$store.commit("setBlogState", this.currentBlog[0]);

    // Asignar los tags del post a la variable 'tags' para que se muestren en el campo de entrada
    this.tags = this.currentBlog[0].tags ? this.currentBlog[0].tags.join(", ") : "";
  },
  methods: {
    fileChange() {
          ...
          docRef.put(this.file).on(
            ...
            async () => {
              ...
              await dataBase.update({
                ...
                tags: tagsArray,  // Actualizar los tags
              });
